...
const translations = {
  es: {
    ...
    "checkout.stripeInfo": "Te redirigimos a Stripe Checkout para procesar el pago.",
    "checkout.selectCity": "Selecciona una ciudad",
    "checkout.retry": "Volver a intentar",
    "checkout.stripeError": "No pudimos conectar con Stripe. Intenta de nuevo.",
  ...
  en: {
    ...
    "checkout.secure": "Secure checkout with Stripe",
    "checkout.stripeInfo": "We redirect you to Stripe Checkout to complete the payment.",
    "checkout.selectCity": "Select a city",
    "checkout.retry": "Try again",
    "checkout.stripeError": "Unable to reach Stripe. Please try again.",
