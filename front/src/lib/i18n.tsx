...
const translations = {
  es: {
    ...
    // Personalization
    "editor.title": "Diseñalo a tu manera",
    ...
    "editor.position": "Posición del estampado",
    "editor.position.left": "Izquierdo",
    "editor.position.center": "Completo",
    "editor.position.right": "Derecho",
    "editor.position.top": "Pecho",
    "editor.position.middle": "Pecho",
    "editor.position.bottom": "Pecho",
